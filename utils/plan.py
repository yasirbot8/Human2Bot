...
def load_args():
    ...
    parser.add_argument('--root', type=str, default='/home/yasir/yas_ws/catkin_ws/src/dvd/', help='root dir') 
    ...
    #parser.add_argument('--num_heads', type=int, default=1, help='number of heads for attention layer')
